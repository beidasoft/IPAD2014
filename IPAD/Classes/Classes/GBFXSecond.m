...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    //cell.tag = [[resultArray objectAtIndex:indexPath.row] objectForKey:@"id"];
    // Configure the cell...
...
{
	//NSLog(@"[[tableView cellForRowAtIndexPath:indexPath]tag]======%d",[[tableView cellForRowAtIndexPath:indexPath]tag]);
	if ([[tableView cellForRowAtIndexPath:indexPath]tag] < 6)
	{
	...
	{
	    GBFXThird *sc = [[GBFXThird alloc] initWithStyle:UITableViewStylePlain];
		sc.tit = [[[tableView cellForRowAtIndexPath:indexPath]textLabel]text];
		sc.condition = [[tableView cellForRowAtIndexPath:indexPath]tag];
		//NSLog(@"sc.condition===%d",sc.condition);
